...
def compute_diff(nuxmfilename, commandfilename, outputfilename, input_condition = None, fsm1_action=None, fsm2_action=None, fsm1_inFile=None, fsm2_inFile=None):
    ...
    cmd = ['./nuXmv','-source', "cmd_property.txt", nuxmfilename]
    print("after bash cmd",nuxmfilename)
    commandfilename="cmd_property.txt"
    print(commandfilename,",,,",nuxmfilename)
    iter = 0
    new_out = None
    prev_out = None
    while True:
        ...
        # print
        # print("action chk:",fsm1_action,"+ :: ",fsm2_action)
        # fsm2_action null
        # print("action lvel: ",action_labels_1,": ",action_labels_2)
        ...
        process = subprocess.Popen(cmd, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True)  # Use text=True for string output
        output, error = process.communicate()
        new_out = output
